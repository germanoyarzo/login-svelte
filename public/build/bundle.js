...
var app = (function () {
    ...
    function createHistory$1(source, options) {
      const listeners = [];
    ...
    const globalHistory$1 = createHistory$1(canUseDOM$1 ? window : createMemorySource$1());
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const location = locationContext || writable(url ? { pathname: url } : globalHistory$1.location);
    	...
    	if (!locationContext) {
    		...
    		onMount(() => {
    			const unlisten = globalHistory$1.listen(history => {
    ...
    /* src\pages\Login.svelte generated by Svelte v3.55.1 */
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-lwh3p0");
    			add_location(h1, file$2, 115, 6, 2903);
    			attr_dev(label0, "class", "svelte-lwh3p0");
    			add_location(label0, file$2, 117, 6, 2926);
    			attr_dev(input0, "name", "email");
    			attr_dev(input0, "placeholder", "name@example.com");
    			attr_dev(input0, "class", "svelte-lwh3p0");
    			add_location(input0, file$2, 118, 6, 2954);
    			attr_dev(label1, "class", "svelte-lwh3p0");
    			add_location(label1, file$2, 120, 6, 3038);
    			attr_dev(input1, "name", "password");
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "class", "svelte-lwh3p0");
    			add_location(input1, file$2, 121, 6, 3069);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "svelte-lwh3p0");
    			add_location(button, file$2, 123, 6, 3144);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file$2, 111, 8, 2817);
    			attr_dev(div, "class", "success svelte-lwh3p0");
    			add_location(div, file$2, 109, 6, 2774);
    		},
    		m: function mount(target, anchor) {
    ...
    // (129:6) {#if Object.keys(errors).length > 0}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "errors svelte-lwh3p0");
    			add_location(ul, file$2, 129, 8, 3342);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(129:6) {#if Object.keys(errors).length > 0}",
    		ctx
    	});
    ...
    // (131:10) {#each Object.keys(errors) as field}
    function create_each_block(ctx) {
    	let li;
    	let t0_value = /*field*/ ctx[12] + "";
    	let t0;
    	let t1;
    	let t2_value = /*errors*/ ctx[4][/*field*/ ctx[12]] + "";
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(": ");
    			t2 = text(t2_value);
    			add_location(li, file$2, 131, 12, 3423);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*errors*/ 16 && t0_value !== (t0_value = /*field*/ ctx[12] + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*errors*/ 16 && t2_value !== (t2_value = /*errors*/ ctx[4][/*field*/ ctx[12]] + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(131:10) {#each Object.keys(errors) as field}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			form = element("form");
    			if_block.c();
    			attr_dev(form, "class", "svelte-lwh3p0");
    			add_location(form, file$2, 107, 2, 2699);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 42, 4, 931);
    			attr_dev(input, "type", "submit");
    			input.value = "Logout";
    			attr_dev(input, "class", "svelte-15694xz");
    			add_location(input, file$1, 45, 12, 1022);
    			attr_dev(form, "class", "svelte-15694xz");
    			add_location(form, file$1, 44, 8, 983);
    			add_location(nav, file$1, 43, 4, 968);
    			add_location(main, file$1, 41, 0, 919);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(form, "submit", /*logout*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('previousPath' in $$props) previousPath = $$props.previousPath;
    	};
    ...
    function create_default_slot_3(ctx) {
    	...
    	login.$on("loggedIn", /*loggedIn*/ ctx[1]);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			if_block.c();
    			add_location(main, file, 39, 2, 685);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-15eqfgx");
    			add_location(section, file, 35, 2, 659);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
